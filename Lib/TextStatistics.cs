...
//operations
        ...
        public int Calculate(WordExtractor we)
        {
                ...
                {
                        Trace.WriteLine(String.Format("TextStatistics.Calculate() raised exception {0}", e.Message));
        ...
        public int SaveCapitalWords(String fileName)
        {
                ...
                {
                        Trace.WriteLine(String.Format("TextStatistics.SaveCapitalWords({0}) raised exception {1}", fileName, e.Message));
        ...
        public int Simulate(int sentencesNumber, out String[] simulationText)
        {
                ...
                {
                        simulationText = null;
                        Trace.WriteLine(String.Format("TextStatistics.Simulate({0}) raised exception {1}", sentencesNumber, e.Message));
