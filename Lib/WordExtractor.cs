...
//Properties        
        /// <summary>
        /// Background worker report callback
        /// </summary>
...
//operations
        ...
        public int Extract(String fileName)
        {
                try
                {
                        ...
                        using (TextReader tr = new StreamReader(fileName))
                        {
                                ...
                                while ((str = tr.ReadLine()) != null)
                                {
                                        ...
                                        {
                                                worker.ReportProgress(0, String.Format("Processing {0} line {1} (found {2} different words)",
                ...
                {
                        Trace.WriteLine(String.Format("WordExtractor.Extract() raised exception {0}", e.Message));
        ...
        public int SaveDictionary(String fileName)
        {
                ...
                {
                        Trace.WriteLine(String.Format("WordExtractor.SaveDictionary() raised exception {0}", e.Message));
        ...
        public int SaveText(String fileName)
        {
                ...
                {
                        Trace.WriteLine(String.Format("WordExtractor.SaveText() raised exception {0}", e.Message));
...
//Fields        
        System.ComponentModel.BackgroundWorker worker = null;           //report callback
        int reportFreq = 1000;
